...
export const SLIDES: SlideData[] = [
  ...
  },
  {
    ...
    punchlineNext: 'And if there is no goal at all – only noise?',
    punchlineNextDE: 'Und wenn es gar kein Ziel gibt – nur Rauschen?',
  ...
  },
  {
    ...
    punchline: 'It picks what fits the context – not what is proven. That is the common root of all three traps.',
    punchlineDE: 'Es wählt, was zum Kontext passt – nicht, was belegt ist. Das ist die gemeinsame Wurzel aller drei Fallen.',
    punchlineNext: 'So how do we get truth in? We hand over the parts where plausibility is not enough.',
    punchlineNextDE: 'Wie kommt dann Wahrheit rein? Wir geben die Teile ab, bei denen „plausibel“ nicht reicht.',
  ...
  },
  {
    ...
    punchline: 'Do not trust the model\'s arithmetic – make the calculation checkable.',
...
3. Die Gesamtkosten ausgibt.`,
  ...
  },
  {
    ...
    punchlineNext: 'Code, search, sources – does every question need all of that?',
    punchlineNextDE: 'Code, Suche, Quellen – braucht jede Frage das alles?',
...
Nenne für jede Person die Quelle (URL).`,
  ...
  },
  {
    ...
    subtitle: 'Use only the guidance the task actually needs.',
    subtitleDE: 'So viel Führung wie nötig – und nicht mehr.',
    content: [
      'Building block 1: Ask directly (simple, low-risk questions)',
      'Building block 2: Add context and examples (role, goal, desired style)',
      'Building block 3: Structure the task (analyse first, then produce the result)',
      'Building block 4: Tools and checks (code, search, sources – when the result must hold up)',
    ],
    contentDE: [
      'Baustein 1: Direkt fragen (einfache, unkritische Fragen)',
      'Baustein 2: Kontext und Beispiele mitgeben (Rolle, Ziel, gewünschter Stil)',
      'Baustein 3: Aufgabe strukturieren (erst analysieren, dann Ergebnis erstellen)',
      'Baustein 4: Werkzeuge und Prüfung (Code, Suche, Quellen – wenn das Ergebnis halten muss)',
    ],
  },
  {
    id: 10,
    ...
    topicDE: 'Aufgaben strukturieren',
...
4. Fehlende Informationen: Markiere, was nicht dokumentiert ist oder sich aus den vorhandenen Informationen nicht ableiten lässt.`,
  ...
  },
  {
    ...
    topic: 'Role, context & goal',
    topicDE: 'Rolle, Kontext & Ziel',
...
Ton: Professionell, sicherheitsbewusst, kooperativ.`,
  ...
  },
  {
    ...
    topic: 'Define the output format',
    topicDE: 'Ausgabeformat festlegen',
...
<bericht>...</bericht>`,
  ...
  },
  {
    ...
    topic: 'Repeatable quality',
    topicDE: 'Wiederholbare Qualität',
...
Erst schließen, wenn die beobachteten Ergebnisse die Abschlusskriterien belegen.`,
  ...
  },
  {
    ...
    topic: 'Falsification, not a finding quota',
    topicDE: 'Falsifikation statt Fundquote',
    ...
    punchlineNext: 'Full circle to the car wash: make goal, checks and evidence visible – and reuse it as a template.',
    punchlineNextDE: 'Zurück zur Waschanlage: Ziel, Prüfkriterien und Belege sichtbar machen – und als Vorlage wiederverwenden.',
