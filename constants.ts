...
export const SLIDES: SlideData[] = [
  ...
  },
  {
    ...
    codeStandardDE: "Lies diesen Bug-Report und sag mir, was schiefgelaufen ist.",
    codeOptimized: "<task>Extract bug report data</task>\n<format>\nReply ONLY in valid JSON:\n{\n  \"date\": \"ISO-8601\",\n  \"severity\": \"low|medium|high|critical\",\n  \"component\": \"string\",\n  \"summary\": \"string (≤ 50 chars)\",\n  \"steps_to_reproduce\": []\n}\n</format>\n<report>...</report>",
    codeOptimizedDE: "<task>Bug-Report-Daten extrahieren</task>\n<format>\nNur als gültiges JSON antworten:\n{\n  \"date\": \"ISO-8601\",\n  \"severity\": \"low|medium|high|critical\",\n  \"component\": \"string\",\n  \"summary\": \"string (≤ 50 Zeichen)\",\n  \"steps_to_reproduce\": []\n}\n</format>\n<report>...</report>",
  ...
  },
  {
    ...
    codeStandardDE: "Ein Server verarbeitet 12.000 Anfragen/Tag bei Spitzenlast. Jede Anfrage benötigt 0,003 CPU-Sekunden. Wie viele CPU-Kerne werden mit einem 3×-Traffic-Puffer benötigt?",
    ...
    codeOptimizedDE: "Ziel: Erforderliche CPU-Kerne berechnen.\nEinschränkung: NICHT selbst berechnen.\nAktion: Schreibe ein Python-Snippet, das:\n1. peak_req_per_day, cost_per_req_cpu_s und spike_factor = 3 definiert.\n2. required_cores mit einer Erklärung berechnet.\n3. Das Ergebnis ausgibt.\nNur den Code-Block zurückgeben, kein Fließtext.",
  ...
  },
  {
    ...
    codeStandardDE: "Schau dir diese Microservice-Architektur an und sag mir, ob sie gut ist.",
    ...
    codeOptimizedDE: "Du bist ein erfahrener Software-Architekt. Reviewe diese Microservice-Architektur in drei expliziten Schritten:\n1. Identifizieren: Jeden Service, seine Einzelverantwortung und direkten Abhängigkeiten auflisten.\n2. Analysieren: Engpässe, Single Points of Failure und enge Kopplung hervorheben.\n3. Empfehlen: Konkrete Verbesserungen nach Business-Impact priorisiert vorschlagen.\nAufzählungspunkte verwenden. Prägnant.",
  ...
  },
  {
    ...
    codeStandardDE: "Schreib eine E-Mail an den Kunden, dass das Projekt verzögert ist.",
    ...
    codeOptimizedDE: "Rolle: Senior Project Manager einer Software-Beratung.\nKontext: Sprint 4 ist aufgrund einer ungeplanten Datenbankmigration um 5 Tage verzögert. Der Kunde ist technisch versiert.\nZiel: Den Kunden informieren, einen neuen Go-Live-Termin vorschlagen und einen 30-minütigen Sync-Call anbieten.\nTon: Professionell, transparent, lösungsorientiert.\nEinschränkung: ≤ 120 Wörter.",
  ...
  },
  {
    ...
    codeStandardDE: "Was sind die aktuellen Node.js LTS-Versionen?",
    ...
    codeOptimizedDE: "Nutze das Web-Search-Tool, um die offizielle Node.js-Releases-Seite abzurufen.\nAus dem abgerufenen Inhalt auflisten:\n- Alle aktuellen Active-LTS-Versionen (Name, Versionsnummer, End-of-Life-Datum)\n- Die aktuelle Maintenance-LTS-Version\nFür jede Aussage die Quell-URL angeben.\nNICHT aus dem Gedächtnis antworten — ausschließlich aus den abgerufenen Inhalten.",
  ...
  },
  {
    ...
    codeStandardDE: "Behebe den Concurrency-Bug im UserAccountService.",
    ...
    codeOptimizedDE: "Ziel: Den Concurrency-Bug in UserAccountService beheben.\nKontext: Den fehlschlagenden Pfad mit Tests in tests/Unit/UserAccountServiceTest.php vergleichen und das unveränderliche Value-Object-Muster aus src/Domain befolgen.\nEinschränkungen: Öffentliche API unverändert lassen. Keine Static-Analysis-Ignores hinzufügen. Keine nicht betroffenen Dateien verändern.\nFertig wenn: Einen Regressionstest hinzufügen, der vor dem Fix fehlschlägt und danach besteht, Static Analysis auf max besteht, rohe Ausgabe einfügen.\nCI-Pipeline ausführen und alle Findings beheben — nicht nach dem ersten akzeptablen Schritt stoppen.",
  ...
  },
  {
    ...
    codeStandardDE: "Vielleicht könntest du versuchen, diesen Code zu verbessern. Vielleicht wäre es sinnvoll, ihn etwas aufzuräumen, falls das möglich ist.",
    ...
    codeOptimizedDE: "Die drei duplizierten Parsing-Schritte in diesem Modul entfernen.\nDie öffentliche API unverändert lassen.\nKeine nicht betroffenen Dateien anfassen.\nDie Testsuite ausführen und die Ausgabe einfügen.\n\nWenn der Build dreimal in Folge fehlschlägt, stoppen.\nKeinen vierten Fix versuchen.\nDie Grundursache zusammenfassen und auflisten, was noch unbekannt ist.",
  ...
  },
  {
    ...
    codeStandardDE: "Schreib Tests für diesen Code und stelle sicher, dass sie alle bestehen.",
    ...
    codeOptimizedDE: "Änderungen mit Tests validieren und den Code korrigieren, falls nötig;\nnicht einfach Tests schreiben, damit sie bestehen, sondern sie zur Validierung nutzen.\n\nWir brauchen Tests auf TDD-Weise: Mit einem fehlschlagenden Test beginnen, nur genug implementieren um zu bestehen, und wiederholen.\nNicht beim Happy Path aufhören — Edge Cases und Fehlerfall-Coverage hinzufügen.\nWenn ein neuer Test keine echte fehlerhafte Annahme, keinen fehlenden Edge Case oder Verhaltensabweichung aufdeckt, ist er noch zu schwach — so lange fortfahren, bis einer es tut.\n\nWenn ein Test fehlschlägt, den Code korrigieren — nicht den Test.",
